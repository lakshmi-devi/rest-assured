...
public class SourcingService {
	...
	public static HashMap<String, Object> getcreateSourcingCardParams(String scriptType, int invocationCount)
			throws Exception {
		try {
			...
			params.put(Statickeys._customStage, Statickeys.sourcing);
